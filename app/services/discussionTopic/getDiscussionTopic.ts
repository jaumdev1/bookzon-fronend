...
export const fetchDiscussionTopics = async (params: FetchDiscussionTopicsParams) => {
  try {
    const response = await baseApi.get('/discussionTopic/paged', {
      params: {
        page: params.page || 0,
        size: params.size || 5,
...
export default fetchDiscussionTopics;
